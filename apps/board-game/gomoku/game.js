...
const { SCORE_HUMAN, SCORE_AI, getBestAIMove } = createGameAI({
  BOARD_SIZE,
  EMPTY,
  BLACK,
  WHITE,
...
if (typeof document !== "undefined") {
  ...
  function drawWinLine(line) {
    ...
    // Glow underneath, then a crisp bright line on top
    context.strokeStyle = "rgba(229, 57, 53, 0.35)";
    context.lineWidth = 8;
    context.stroke();
